...
public class AdminRegister {
    ...
    void btnRegister(ActionEvent event) {
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/busapplication", "root", "Ejgaming1234");

            pst = con.prepareStatement("insert into Admin(AdminName, AdminEmail, AdminPassword, AdminConfirmPassword) VALUES (?, ?, ?, ?)");
